...
//            new DemoDetails(R.string.location_source_demo_label,        // Not sure what this will help
//                    R.string.location_source_demo_description,
//                    LocationSourceDemoActivity.class),
//            new DemoDetails(R.string.map_in_pager_demo_label,         // did not work
//                    R.string.map_in_pager_demo_description,
//                    MapInPagerDemoActivity.class),
//            new DemoDetails(R.string.marker_demo_label,               // manipulate angle of markers
